#!/bin/bash
# build-v3.sh – Full website generator for Rajshahi Online Hosting V3.0

set -e

echo "🚀 Generating Rajshahi Online Hosting Website V3.0..."
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    console.log('Rajshahi Online Hosting — Version 3.0');
});
EOF
...
# ============================================================
# 3. HTML PAGES (only index.html for brevity; others can be copied)
# ============================================================
...
# ============================================================
# 4. OTHER FILES (placeholders for other pages, configs)
# ============================================================

# Create other pages (minimal copies for now)
echo "Creating placeholder pages..."
for page in about hosting vps dedicated reseller bdix domains ssl contact training career privacy terms sitemap status 404 enterprise_service; do
    if [ "$page" == "404" ]; then
        filename="404.html"
    else
        filename="${page}.html"
    ...
    cat > "$filename" << EOF
<!DOCTYPE html>
<html lang="en"><head><meta charset="UTF-8"><title>${page} — Rajshahi Online</title>
<link rel="icon" href="assets/base/img/layout/favicon.ico" />
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" />
...
<main><section class="enterprise-hero" style="min-height:300px; padding:60px 0;"><div class="container"><h1>${page}</h1><p>Content coming soon for V3.</p></div></section></main>
...
echo "✅ V3 Website generation complete!"
echo "Now run: git add . && git commit -m 'Version 3.0' && git push origin master:main"